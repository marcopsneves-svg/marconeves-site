  ...
  return (
    <div style={{background:'#08142a',minHeight:'100vh',fontFamily:'Montserrat,sans-serif',color:'#fff'}}>
      <div style={{background:'linear-gradient(135deg,#08142a,#1a3670)',padding:'60px 20px 50px',textAlign:'center'}}>
        ...
        <h1 style={{fontSize:'clamp(24px,5vw,42px)',fontWeight:800,marginBottom:16}}>Especialista em <span style={{color:'#cc1f1f'}}>Alenquer</span></h1>
        <p style={{fontSize:15,color:'#7a8daa',maxWidth:560,margin:'0 auto 28px',lineHeight:1.7}}>Avaliação gratuita do seu imóvel em Alenquer. Resposta em menos de 24 horas.</p>
        <div style={{display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap'}}>
          <a href="https://wa.me/351969692793?text=Olá Marco, quero saber mais sobre imóveis em Alenquer" target="_blank" rel="noreferrer" style={{background:'#25D366',color:'#fff',padding:'13px 24px',borderRadius:50,fontWeight:700,fontSize:13,textDecoration:'none',display:'flex',alignItems:'center',gap:8}}>
      ...
      <div style={{maxWidth:720,margin:'0 auto',padding:'60px 20px'}}>
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Imobiliário em <span style={{color:'#cc1f1f'}}>Alenquer</span></h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <p style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,marginBottom:16,fontSize:15}}>Alenquer é um dos concelhos com maior potencial de valorização na zona norte de Lisboa. Com paisagens únicas do vale do Tejo às encostas vinhateiras, o concelho atrai famílias e investidores que procuram imóveis com espaço e tranquilidade a preços ainda competitivos.</p>
        <p style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,marginBottom:16,fontSize:15}}>Em 2026, o preço mediano dos imóveis em Alenquer situa-se nos 199.000€, com valores por m² entre 1.600€ e 2.400€ dependendo da localização e tipo de imóvel. Uma oportunidade real para quem quer investir antes da valorização se consolidar.</p>
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(150px,1fr))',gap:14,margin:'28px 0'}}>
          {[['199.000€','Preço mediano'],['1.600-2.400€','Por m²'],['60-100 dias','Tempo médio venda']].map(([num,label])=>(
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Serviços em <span style={{color:'#cc1f1f'}}>Alenquer</span></h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <ul style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,paddingLeft:20,marginBottom:32,fontSize:15}}>
          <li style={{marginBottom:10}}><strong>Avaliação gratuita do imóvel</strong> — Análise comparativa com dados reais de transações recentes em Alenquer</li>
          ...
          <li style={{marginBottom:10}}><strong>Prospeção de compradores</strong> — Base de dados ativa de compradores à procura de imóveis em Alenquer</li>
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Quanto vale o seu imóvel em <span style={{color:'#cc1f1f'}}>Alenquer</span>?</h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <FormAvaliacao concelho="Alenquer" />
      </div>
