  ...
  return(
    <div style={{background:'#08142a',minHeight:'100vh',fontFamily:'Montserrat,sans-serif',color:'#fff'}}>
      <div style={{background:'linear-gradient(135deg,#08142a,#1a3670)',padding:'60px 20px 50px',textAlign:'center'}}>
        ...
        <h1 style={{fontSize:'clamp(24px,5vw,42px)',fontWeight:800,marginBottom:16}}>Especialista em <span style={{color:'#cc1f1f'}}>Vila Franca de Xira</span></h1>
        <p style={{fontSize:15,color:'#7a8daa',maxWidth:560,margin:'0 auto 28px',lineHeight:1.7}}>A minha zona de especialização principal. Avaliação gratuita em menos de 24 horas.</p>
        <div style={{display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap'}}>
          <a href="https://wa.me/351969692793?text=Olá Marco, quero saber mais sobre imóveis em Vila Franca de Xira" target="_blank" rel="noreferrer" style={wa}>{waIcon}WhatsApp</a>
      ...
      <div style={{maxWidth:720,margin:'0 auto',padding:'60px 20px'}}>
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Imobiliário em <span style={{color:'#cc1f1f'}}>Vila Franca de Xira</span></h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <p style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,marginBottom:16,fontSize:15}}>Vila Franca de Xira é o meu mercado de especialização. Com 11 freguesias — Alverca do Ribatejo, Póvoa de Santa Iria, Alhandra, Castanheira do Ribatejo, Forte da Casa entre outras — é um dos concelhos com maior dinamismo da Área Metropolitana de Lisboa.</p>
        <p style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,marginBottom:16,fontSize:15}}>Em 2026, o preço mediano situa-se nos 311.000€, com apartamentos a atingir 3.609€/m² e moradias 2.814€/m². A linha ferroviária do Norte permite chegar a Lisboa em 20 minutos, o que mantém a procura sempre elevada.</p>
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(150px,1fr))',gap:14,margin:'28px 0'}}>
          {[['3.609€/m²','Apartamentos'],['2.814€/m²','Moradias'],['45-75 dias','Tempo médio venda']].map(([num,label])=>(
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Serviços em <span style={{color:'#cc1f1f'}}>Vila Franca de Xira</span></h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <ul style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,paddingLeft:20,marginBottom:32,fontSize:15}}>
          <li style={{marginBottom:10}}><strong>Avaliação gratuita do imóvel</strong> — Análise comparativa com dados reais de transações recentes no concelho</li>
          ...
          <li style={{marginBottom:10}}><strong>Prospeção de compradores</strong> — Base de dados ativa de compradores à procura de imóveis em VFX</li>
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Quanto vale o seu imóvel em <span style={{color:'#cc1f1f'}}>Vila Franca de Xira</span>?</h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <FormAvaliacao concelho="Vila Franca de Xira"/>
      </div>
