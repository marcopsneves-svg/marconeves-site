...
const FOTO = 'https://www.marconevesimobiliario.com/images/marco-camisa.jpg';
  ...
  return (
    <div style={{background:'#08142a',minHeight:'100vh',fontFamily:'Montserrat,sans-serif',color:'#fff'}}>
      <div style={{background:'linear-gradient(135deg,#08142a,#1a3670)',padding:'60px 20px 50px',textAlign:'center'}}>
        ...
        <h1 style={{fontSize:'clamp(24px,5vw,42px)',fontWeight:800,marginBottom:16}}>Especialista em <span style={{color:'#cc1f1f'}}>Mafra</span></h1>
        <p style={{fontSize:15,color:'#7a8daa',maxWidth:560,margin:'0 auto 28px',lineHeight:1.7}}>Avaliação gratuita do seu imóvel em Mafra. Resposta em menos de 24 horas.</p>
        <div style={{display:'flex',gap:12,justifyContent:'center',flexWrap:'wrap'}}>
          <a href="https://wa.me/351969692793?text=Olá Marco, quero saber mais sobre imóveis em Mafra" target="_blank" rel="noreferrer" style={{background:'#25D366',color:'#fff',padding:'13px 24px',borderRadius:50,fontWeight:700,fontSize:13,textDecoration:'none',display:'flex',alignItems:'center',gap:8}}>
          ...
          <a href="tel:+351969692793" style={{background:'rgba(255,255,255,.12)',color:'#fff',padding:'13px 24px',borderRadius:50,fontWeight:700,fontSize:13,textDecoration:'none',border:'1px solid rgba(255,255,255,.2)',display:'flex',alignItems:'center',gap:8}}>📞 969 692 793</a>
        </div>
      </div>
      <div style={{maxWidth:720,margin:'0 auto',padding:'60px 20px'}}>
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Imobiliário em <span style={{color:'#cc1f1f'}}>Mafra</span></h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <p style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,marginBottom:16,fontSize:15}}>Mafra é um dos concelhos com maior valorização imobiliária na zona norte de Lisboa. A proximidade com a Ericeira — reserva mundial de surf — e os excelentes acessos pela A21 e A8 tornaram este mercado num dos mais atrativos para famílias e investidores.</p>
        <p style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,marginBottom:16,fontSize:15}}>Em 2026, os apartamentos atingem em média 4.661€/m² e as moradias 3.790€/m², valores que refletem a forte procura e a limitada oferta de qualidade no concelho.</p>
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(150px,1fr))',gap:14,margin:'28px 0'}}>
          {[['4.661€/m²','Apartamentos'],['3.790€/m²','Moradias'],['60-90 dias','Tempo médio venda']].map(([num,label])=>(
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Serviços em <span style={{color:'#cc1f1f'}}>Mafra</span></h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <ul style={{color:'rgba(255,255,255,.75)',lineHeight:1.8,paddingLeft:20,marginBottom:32,fontSize:15}}>
          <li style={{marginBottom:10}}><strong>Avaliação gratuita do imóvel</strong> — Análise comparativa com dados reais de transações recentes em Mafra</li>
          ...
          <li style={{marginBottom:10}}><strong>Prospeção de compradores</strong> — Base de dados ativa de compradores à procura de imóveis em Mafra</li>
        ...
        <h2 style={{fontSize:'clamp(20px,4vw,30px)',fontWeight:800,marginBottom:16}}>Quanto vale o seu imóvel em <span style={{color:'#cc1f1f'}}>Mafra</span>?</h2>
        <div style={{width:48,height:3,background:'linear-gradient(to right,#cc1f1f,transparent)',borderRadius:2,marginBottom:28}}/>
        <FormAvaliacao concelho="Mafra" />
      </div>
