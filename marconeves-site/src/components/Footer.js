    ...
    <footer className="footer">
      <div className="footer-inner">
        <div className="footer-brand">
          <span className="footer-name">Marco Neves</span>
          <span className="footer-sub">Consultor Imobiliário · RE/MAX</span>
          <p className="footer-desc">
            Especialista em compra, venda e arrendamento de imóveis em Lisboa e arredores.
            Compromisso, confiança e resultados.
          </p>
        </div>
      ...
      <div className="footer-bottom">
        <p>© {new Date().getFullYear()} Marco Neves · RE/MAX. Todos os direitos reservados.</p>
